...
bitcore-message-tent adds support for verifying and signing TENT messages in [Node.js](http://nodejs.org/) and web browsers.
...
```sh
npm install bitcore-message-tent
```

```sh
bower install bitcore-message-tent
```
...
var Message = require('bitcore-message-tent');
